        ...
        <div className="ContenedorDerecho">
          <form className="ContenedorForm" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input type="email" id="email" name="email" placeholder="Ingrese nuevamente su email" required />
            </div>
            <div>
              <label htmlFor="email">Número de contacto:</label>
              <input type="text" id="numero" name="numero" placeholder="Ingresar característa del pais y el número de contacto" required />
            </div>
            <div>
              <label htmlFor="message">Mensaje:</label>
              <textarea id="message" name="message" rows="4" placeholder="Ingrese aquí su consulta" required />
            </div>
